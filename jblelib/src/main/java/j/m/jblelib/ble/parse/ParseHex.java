...
public class ParseHex implements Parse {
    ...
    private java.util.ArrayList<j.m.jblelib.ble.data.SatelliteData> satelliteDatas = new java.util.ArrayList();
    private int pos = 0;
    ...
    private void getLocationData(int q) {
        ...
        BleCallbackManager.INSTANCE.callback(BleCallbackManager.INSTANCE.getLOCATION_DATA(), locationStatus);
    }
    ...
    private void getSatelliteData(int q) {
        ...
        BleCallbackManager.INSTANCE.callback(BleCallbackManager.INSTANCE.getSATELLITE_DATA(), satellites, satelliteType);
    }
