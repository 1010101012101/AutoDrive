...
import j.m.jblelib.ble.bleoperation.BleConnect
import j.m.jblelib.ble.bleoperation.BleScan
import j.m.jblelib.ble.bleoperation.BleWrite
import j.m.jblelib.ble.bleoperation.BleConnectedDevice
...
object BleHelper {
    ...
    fun openBle(a: Activity, request: Int) {
        ...
        if (!bleIsOpen()) {
            ...
            a.startActivityForResult(enableBtIntent, BleHelper.REQUEST_CODE)
        }
    }

    @SuppressLint("MissingPermission")
    fun bleIsOpen(): Boolean {
        return BleHelper.bleManager.adapter != null && BleHelper.bleManager.adapter.isEnabled()
    }
